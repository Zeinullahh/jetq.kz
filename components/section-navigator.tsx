...
export function SectionNavigator({ sections, pageLabel }: SectionNavigatorProps) {
  ...
  return (
    <aside className="fixed left-4 top-1/2 z-40 hidden -translate-y-1/2 w-48 flex-col lg:flex">
      <div className="rounded-lg border border-border bg-card/95 p-4 shadow-lg backdrop-blur">
        <p className="mb-1 text-[10px] font-normal uppercase tracking-widest text-muted-foreground">
          Разделы страницы
        </p>
        {pageLabel && (
