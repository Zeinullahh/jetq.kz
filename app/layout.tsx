    ...
    <html lang="ru" suppressHydrationWarning>
      <body className={cn(oswald.variable, "font-sans")}>
        ...
        <noscript>
          <div>
            <img
              src="https://mc.yandex.ru/watch/111792617"
        ...
        <Script id="yandex-metrika" strategy="afterInteractive">
          {`
            ...
            })(window, document,'script','https://mc.yandex.ru/metrika/tag.js?id=111792617', 'ym');

            ym(111792617, 'init', {ssr:true, webvisor:true, clickmap:true, ecommerce:"dataLayer", referrer: document.referrer, url: location.href, accurateTrackBounce:true, trackLinks:true});
          `}
        </Script>
        {/* /Yandex.Metrika counter */}
        <CookieConsent />
